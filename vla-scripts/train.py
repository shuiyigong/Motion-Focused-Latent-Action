...
class TrainConfig:
    ...
    pretrain_vlm: str = 'MFVLA/models/prism_backbone/prism-dinosiglip-224px+7b'
    lam_path: str = "MFVLA/logs/task_centric_lam_stage2/epoch=1-step=15000.ckpt"
...
def train(cfg: TrainConfig) -> None:
    ...
    cfg.run_id = (
        f"{vla_id}+n{cfg.vla.expected_world_size // 8}+b{cfg.per_device_batch_size}+x{cfg.seed}_bridgeall_whole"
    ...
    cfg.run_id += '-Latent-Action-Pretraining-bridgeall'  
