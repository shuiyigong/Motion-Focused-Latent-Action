...
@dataclass
class Exp_DinoSigLIP_224px_Bridge_Furniture(Exp_SigLIP_224px_Bridge):
    vla_id: str = "prism-dinosiglip-224px+mx-bridge-furiniture"
    base_vlm: Union[str, Path] = "prism-dinosiglip-224px+7b"

    data_mix: str = "bridge_furniture"
...
class VLARegistry(Enum):
    ...
    # Pre-training on Bridge-v2 data + Furniture subset
    DINOSIGLIP_224PX_MX_BRIDGE_FURNITURE = Exp_DinoSigLIP_224px_Bridge_Furniture
