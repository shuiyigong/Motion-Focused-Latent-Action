...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    # === bridge + furniture_bench Dataset ===
    "bridge_furniture": [
        ("bridge_oxe", 1.0),                                      # Version of Bridge V2 in Open-X GCP Bucket                                # Original Version of Bridge V2 from Project Website
        ("furniture_bench_dataset_converted_externally_to_rlds", 0.1),
    ],
    "brideg_egodex_mix": [
        ("bridge_oxe", 0.5),                                      # Version of Bridge V2 in Open-X GCP Bucket                                # Original Version of Bridge V2 from Project Website
        ("ego_dex_dataset", 0.5),
    ],
    "furniture": [
